  ...
  return (
    <div className="login-page">
      <div className="login-container">
        ...
        <h2 className="login-header">HOŞGELDİNİZ</h2>
        <Form layout="vertical" onFinish={handleLogin} className="login-form">
          <Form.Item label={<span className="login-input-label">E-posta Adresi</span>}>
            <Input
              type="email"
              value={email}
          ...
          <Form.Item label={<span className="login-input-label">Şifre</span>}>
            <Input.Password
              value={password}
        ...
        <div className="login-signup-section">
          ...
          <a className="login-signup-link" onClick={() => navigate("/signup")}>
            Kayıt Ol
          </a>
        </div>
      </div>
